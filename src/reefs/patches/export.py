...
def export_patch_dataset(
    *,
    ...
    metadata: dict[str, object] = {
        ...
        "selected_external_count": selection.selected_external_count,
        "unused_external_count": selection.unused_external_count,
        "selected_local_count": selection.selected_internal_count,
        "selected_support_count": selection.selected_external_count,
        "max_cameras": selection.max_cameras,
        "external_support_fraction": selection.external_support_fraction,
        "external_support_allowance": selection.external_support_allowance,
        "internal_patch_target": selection.internal_patch_target,
        ...
        "selector": {
            ...
            "warning_thresholds": selection.warning_thresholds(),
