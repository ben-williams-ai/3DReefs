...
def smoke(*, config: AblationConfig, simulate: bool) -> None:
    ...
    fake_config = AblationConfig(
        ...
        validation_allow_full_resolution_target=config.validation_allow_full_resolution_target,
        ...
        sfm_rows.append(
            {
                ...
                "selected_sparse_model_path": "preview/sfm/sparse/0",
                "selected_sparse_model_copy_path": "preview/sfm/selected_sparse",
