...
def write_plan_markdown(config: AblationConfig, path: Path) -> None:
    ...
    lines.extend(
        [
            ...
            "## SfM Sweep",
            "",
            "Each SfM job runs the full dataset, generates patch400 patches, and records reconstruction metrics.",
            "",
    ...
    lines.extend(
        [
            ...
            "## Splat Sweep",
            "",
            "The splat sweep reuses the best overall SfM result and trains five deterministic validation patches per row.",
            "",
