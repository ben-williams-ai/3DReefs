...
The selector should use COLMAP tracks only for `visible_patch_track_count`. It should use the full wildflow patch rectangle plus candidate camera frustum geometry for `footprint_overlap_score` and `target_image_share`.
