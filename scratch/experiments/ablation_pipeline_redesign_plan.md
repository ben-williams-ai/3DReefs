...
4. Full-resolution eval proof:
   ...
   - [ ] compare one full-res/full-resolution-derived target against one downsampled variant.
...
- [ ] Public-IP quota and intended parallelism are checked immediately before launch.
